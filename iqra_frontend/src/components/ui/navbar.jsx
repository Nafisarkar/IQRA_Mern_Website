...
const Navbar = () => {
  ...
  return (
    <div className="drawer drawer-mobile relative font-poppins">
      <input id="my-drawer-3" type="checkbox" className="drawer-toggle" />
      <div className="drawer-content flex flex-col">
        {/* Nav */}
        <div className="navbar bg-base-300 w-full px-8 ">
          ...
          <div className="mx-2 flex-1 font-hind font-bold text-2xl">
            {/* <NavLink to={"/"}>QuranSunnah</NavLink> */}
      ...
      <div className="drawer-side fixed z-20">
        ...
        <ul className="menu bg-base-200 min-h-screen w-80 px-4 pt-14 text-left">
          ...
          <li>
            <NavLink to="/" className={"font-hind"}>
              হোম
            </NavLink>
          </li>
          <li>
          ...
          <li className="font-hind">
            <a className="justify-start" onClick={toggleTheme}>
